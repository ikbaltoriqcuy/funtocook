...
<body>
    ...
    <header>
        <ul>
			...
			<li><a href="createMateri.php"> Make Materi </a> </li>
            <li class="dropdown">
                <a href="#" class="dropbtn">Make Game</a>
                <div class="dropdown-content">
                    <a href="MakeGamePilgan.php">&nbsp;&nbsp;&nbsp;Pilgan </a>
...
?>
	...
	<form action="" method="post" name="makemateri" enctype="multipart/form-data">
		...
		<div class="title">
			<input id="Text1" name="judul" type="text" placeholder="Title is Here......." />        
		</div>
		<br /><br />
		<div class="n" >
			<div class="materi">
				<div class="content-materi">
					...
					<div align="center">
						...
						<input id="File1" type="file" name="data_upload"/>
						<input id="button" type="submit" value="Upload" name='Upload' />
					</div>
					<p align="center">
						<textarea id="TextArea1" name="data" rows="2" cols="20" value="" placeholder="Your Materi is Here...."></textarea>
					</p>
				   <br /><br /><br />
					<hr />
		...
		if(isset($_REQUEST['submit'])){
			...
			$query = oci_parse($conn , "select getRows as jumlah from dual");
			oci_execute($query);
